      ...
      <div class="row text-center">
         <div class="col-sm-2">
            ...
            <form action="GetGenre" method="get" style="padding-bottom:10px;">
               ...
               <label class="checkbox"><input type="checkbox" name="genrebox" value="Horror">Horror</label>
               <label class="checkbox"><input type="checkbox" name="genrebox" value="Romance">Romance</label>
               <label class="checkbox"><input type="checkbox" name="genrebox" value="Thriller">Thriller</label>
         ...
         <div class="col-sm-10">
            <div class="row text-center">
               <!--Enter Items Here -->
               <c:forEach items="${sessionScope.books}" var="x">
