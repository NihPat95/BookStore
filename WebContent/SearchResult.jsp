      ...
      <div class="row text-center">
         <div class="col-sm-2">
            ...
            <div class="listcheckboxes">
               <label class="checkbox"><input type="checkbox" name="checkbox">Comedy</label>
               <label class="checkbox"><input type="checkbox" name="checkbox">Fantasy</label>
               <label class="checkbox"><input type="checkbox" name="checkbox">Fiction</label>
               <label class="checkbox"><input type="checkbox" name="checkbox">Horror</label>
               <label class="checkbox"><input type="checkbox" name="checkbox">Romantic</label>
               <label class="checkbox"><input type="checkbox" name="checkbox">Thriller</label>
           </div>
         </div>
         <div class="col-sm-10">
            <div class="row text-center">
               ...
               <div class="col-sm-3 itemp">
                  ...
                  <div class="row">
                     ...
                     <a href="AddToCart?id=${x.getISBN()}&flag=searchresult">Add To Cart</a>
                     </span>
                  </div>
               </div>
               </c:forEach>
               <%session.setAttribute("searchresult",null); %>
               <!--Enter Items Here Ends-->
            </div>
         </div>
      </div>
      <!--List Items end-->
